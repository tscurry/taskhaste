    ...
    <>
      <nav className="fixed h-screen lg:w-[17%] w-[13%] lg:pt-[100px] pt-[125px] mr-[200px]">
        <div className="hidden lg:flex lg:mb-[75px] items-center flex-col">
          ...
          <label
            htmlFor="edit-photo"
            className="flex items-center justify-center w-[90px] text-sm h-[30px] rounded bg-primary text-white hover:scale-[105%] transition-transform duration-500 cursor-pointer"
          >
            Edit
          </label>
          <input type="file" accept="image/*" hidden id="edit-photo" />
        </div>
