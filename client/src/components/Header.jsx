  ...
  return (
    <header className="sticky w-full top-0 z-50 bg-background">
      <nav className="mx-auto flex justify-between py-5 px-11 text-center max-sm:px-5">
        ...
        <div>
          <button className="font-semibold border border-primary hover:scale-[105%] transition-transform duration-500 rounded mr-3 w-24 p-1 text-sm max-sm:text-xs max-sm:mx-0 max-sm:w-20">
            Log In
          </button>
          <button className="font-semibold border border-primary hover:scale-[105%] transition-transform duration-500 rounded ml-3 w-24 p-1 text-sm bg-primary text-white max-sm:text-xs max-sm:w-20">
            Sign Up
          </button>
        </div>
      </nav>
